...
ENT="python train_dist.py --num_process_per_node $NGPU --resume --pretrained=../exp/0627/car/464ad6h_hvae_lion_B8/checkpoints/snapshot"
kl=0.5  
lr=1e-3
latent=1
skip_weight=0.01 
...
$ENT ddpm.num_steps 1 ddpm.ema 0 \
    ...
    viz.viz_freq -400 viz.log_freq -1 viz.val_freq 20 \
    data.batch_size $BS viz.save_freq 20 \
